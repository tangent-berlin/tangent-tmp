...
export default async function ProjectsPage() {
	...
	const top2 = allProjects.find((project) => project.featured === "top2")!;
	const top3 = allProjects.find((project) => project.featured === "top3")!;
				...
				<div className="grid grid-cols-1 gap-8 mx-auto lg:grid-cols-2 ">
					{featured && <Card>
						<article className="relative h-full w-full p-4 md:p-8">
							...
							<h2
								id="featured-post"
								className="mt-4 text-3xl font-regular  text-zinc-100 group-hover:text-white sm:text-4xl font-display"
							>
								{featured.title}
							</h2>
